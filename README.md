...
#### 方法1: 「おまかせ」で自動生成（推奨）
Issueのスライド内容欄に **「おまかせ」** とだけ入力すれば、Claude GitHub Appがタイトルと設定から適切なコンテンツを自動生成します。考えがまとまっていない段階でも、考えるきっかけとして活用できます。

#### 方法2: 作りたい内容を自然に記述
スライドにまとめたい内容を自然な言葉で記述するだけでOKです。詳細に書くと出力の精度が上がります。

**記載例：**
- 「GitHubActionsの基本的な使い方を説明したい」
- 「CI/CDパイプラインの構築方法、メリット、具体例を含めて」
- 「初心者向けにGitの基本コマンドを解説。実例を多めに」

#### 方法3: 事前にAIでコンテンツを準備
Claude/ChatGPTで事前に生成したMarkdown形式のスライド内容を貼り付けることもできます。
